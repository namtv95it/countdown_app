...
class LocalizationService {
  ...
  static final Map<String, Map<String, String>> _translations = {
    'vi': {
      ...
      'add_widget': 'Thêm Widget vào Màn hình chính',
      'add_widget_desc': 'Ghim tiện ích đếm ngược ra ngoài màn hình',
      'add_widget_failed': 'Không thể thêm Widget. Vui lòng thêm thủ công từ Màn hình chính.',
      ...
      'sign_in': 'Đăng nhập',
      'sign_in_to_save_benefits': 'Đăng nhập Google để quyền lợi không mất khi xóa app hoặc đổi máy.',
    ...
    'en': {
      ...
      'add_widget': 'Add Widget to Home Screen',
      'add_widget_desc': 'Pin the countdown widget to your home screen',
      'add_widget_failed': 'Could not add widget. Please add it manually from the home screen.',
      ...
      'sign_in': 'Sign in',
      'sign_in_to_save_benefits': 'Sign in with Google to keep your benefits even after reinstalling or switching devices.',
